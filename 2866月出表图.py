# -*- coding: utf-8 -*-
"""
Created on Wed Sep 16 20:42:50 2020
...
This_month = '08'
#月份周期长度，两位输入
month_cycle_range = '01-31'


#input基础数据,DataFrame格式
Last_month_data = pd.read_excel('【%s%s】月报数据_2866.xlsx' % (Last_month,month_cycle_range))
This_month_data = pd.read_excel('【%s%s】月报数据_2866.xlsx' % (This_month,month_cycle_range))
...
Total_trip_per_day = np.round(Total_trip /This_month_cycle,0)
...
#设置标题
ax1.set_title("%s月车辆行驶里程情况" % This_month,fontsize='18')  
...
plt.savefig('./%s月车辆行驶里程情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
ax1 = fig.add_subplot(111)
#设置标题
ax1.set_title("%s月车辆出班趟次情况" % This_month,fontsize='18')  
...
plt.savefig('./%s月车辆出班趟次情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
Total_split_Last['日均出班趟次'] = round(Total_split_Last['周期出班趟次']/Last_month_cycle)
Total_split_This['日均出班趟次'] = round(Total_split_This['周期出班趟次']/This_month_cycle)
...
ax1 = fig.add_subplot(111)
#设置标题
ax1.set_title("【运输单位】单位组%s月车辆行驶里程情况" % This_month,fontsize='18')  
...
plt.savefig('./【运输单位】单位组%s月车辆行驶里程情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
ax1 = fig.add_subplot(111)
#设置标题
ax1.set_title("【运输单位】单位组%s月车辆出班趟次情况" % This_month,fontsize='18')  
...
plt.savefig('./【运输单位】单位组%s月车辆出班趟次情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
ax1 = fig.add_subplot(111)
#设置标题
ax1.set_title("【经营单位】单位组%s月车辆行驶里程情况" % This_month,fontsize='18')  
plt.bar(x=range(len(x)), height=y1, label='总行驶里程（万公里）', color='blue', alpha=0.6, width=bar_width)
plt.bar(x=np.arange(len(x)) + bar_width, height=y2, label='日均行驶里程（万公里）', color='orange', alpha=0.8, width=bar_width)
plt.bar(x=np.arange(len(x)) + 2*bar_width, height=y3, label='单车日均行驶里程（公里）', color='gray', alpha=0.5, width=bar_width)
...
plt.savefig('./【经营单位】单位组%s月车辆行驶里程情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
ax1 = fig.add_subplot(111)
#设置标题
ax1.set_title("【经营单位】单位组%s月车辆出班趟次情况" % This_month,fontsize='18')  
plt.bar(x=range(len(x)), height=y1, label='总出班趟次', color='orange', alpha=0.8, width=bar_width)
plt.bar(x=np.arange(len(x)) + bar_width, height=y2, label='日均出班趟次', color='blue', alpha=0.6, width=bar_width)
...
plt.savefig('./【经营单位】单位组%s月车辆出班趟次情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
ax1 = fig.add_subplot(111)
#设置标题
ax1.set_title("【其他单位】单位组%s月车辆行驶里程情况" % This_month,fontsize='18')  
plt.bar(x=range(len(x)), height=y1, label='总行驶里程（万公里）', color='blue', alpha=0.6, width=bar_width)
plt.bar(x=np.arange(len(x)) + bar_width, height=y2, label='日均行驶里程（万公里）', color='orange', alpha=0.8, width=bar_width)
plt.bar(x=np.arange(len(x)) + 2*bar_width, height=y3, label='单车日均行驶里程（公里）', color='gray', alpha=0.5, width=bar_width)
...
plt.savefig('./【其他单位】单位组%s月车辆行驶里程情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
ax1 = fig.add_subplot(111)
#设置标题
ax1.set_title("【其他单位】单位组%s月车辆出班趟次情况" % This_month,fontsize='18')  
plt.bar(x=range(len(x)), height=y1, label='总出班趟次', color='orange', alpha=0.8, width=bar_width)
plt.bar(x=np.arange(len(x)) + bar_width, height=y2, label='日均出班趟次', color='blue', alpha=0.6, width=bar_width)
...
plt.savefig('./【其他单位】单位组%s月车辆出班趟次情况.png' % This_month ,dpi=600,bbox_inches = 'tight')
...
Subregion_split_table.columns = ['%s月行驶里程' % This_month,'%s月总里程' % Last_month]
Subregion_split_table['差额'] = Subregion_split_table['%s月行驶里程' % This_month] -  Subregion_split_table['%s月总里程' % Last_month]
...
writer = pd.ExcelWriter('需要放入ppt的表.xlsx')
